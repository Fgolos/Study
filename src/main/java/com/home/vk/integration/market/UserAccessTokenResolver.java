...
public class UserAccessTokenResolver {
    ...
    public static UserAccessTokenResolver fedorTokenResolver() throws ClientException, ApiException {
        int appId = 5908645;
        String secret = "XAwD3qvLx5wWvCzc6vNj";
        return new UserAccessTokenResolver(appId, secret);
    }

    public static void main(String[] args)
            throws ClientException, ApiException {
        final UserAccessTokenResolver userAccessTokenResolver = fedorTokenResolver();
